...
When performing classification tasks you sometimes want to obtain the probability of a class label instead of the class label itself. For example, it might be interesting to determine the risk of cancer for a patient. A calibrated model delivers predicted probabilities very close to the actual class membership probabilities. This framework enables users to measure the calibration of binary classification models.
\
